...
- Administratoren bekommen täglich eine Push-Benachrichtigung ("Daten werden bald gelöscht"), solange Benutzerkonten, Kunden oder Mitarbeiter in den nächsten 30 Tagen von der automatischen Bereinigung gelöscht werden; sie öffnet die neue Seite "Einstellungen > Anstehende Löschungen", die auflistet, was gelöscht wird (Benutzerkonten, Kunden, Mitarbeiter - jeweils nur mit der passenden Berechtigung), und lässt sich in "Mein Konto" unter Benachrichtigungen abschalten.
