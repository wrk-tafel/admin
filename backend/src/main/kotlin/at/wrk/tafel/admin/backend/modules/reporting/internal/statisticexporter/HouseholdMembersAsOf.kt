 ...
 * born after that day is left out, and so is a person flagged `excludeFromHousehold` ("Nicht im
 * Haushalt"), who is recorded on the household but not part of it.
 *
 ...
 */
internal fun HouseholdEntity.additionalPersonsAsOf(referenceDate: LocalDate): List<PersonEntity> = additionalPersons()
    .filterNot { it.excludeFromHousehold }
    .filterNot { it.birthDate?.isAfter(referenceDate) == true }
