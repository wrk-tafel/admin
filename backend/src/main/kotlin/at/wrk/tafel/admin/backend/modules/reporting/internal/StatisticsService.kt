...
class StatisticsService(
    ...
    fun getData(fromDate: LocalDate, toDate: LocalDate): StatisticsData {
        ...
        val personsValidCount = customersValid.flatMap { it.additionalPersons }.count() + customersValidCount

        return StatisticsData(
            customersValid = customersValid.size,
            personsValid = personsValidCount,
        )
    }
