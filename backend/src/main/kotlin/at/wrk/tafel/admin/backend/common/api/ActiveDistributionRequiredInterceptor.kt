...
@Component
class ActiveDistributionRequiredInterceptor(
    ...
    override fun preHandle(request: HttpServletRequest, response: HttpServletResponse, handler: Any): Boolean {
        if (handler is HandlerMethod) {
            ...
            val methodAnnotation = handler.method.getAnnotation(ActiveDistributionRequired::class.java)
            val classAnnotation = handler.beanType.getAnnotation(ActiveDistributionRequired::class.java)
