...
class CustomerServiceTest {
    ...
    @Test
    fun `get customers`() {
        val pageRequest = PageRequest.of(3, 25)
        ...
        val searchResult = service.getCustomers(page = pageRequest.pageNumber)

        assertThat(searchResult.currentPage).isEqualTo(pageRequest.pageNumber + 1)
