package at.wrk.tafel.admin.backend.modules.checkin.service.internal
...
internal class ScannerInternalServiceTest {

    private lateinit var service: ScannerInternalService

    @BeforeEach
    fun beforeEach() {
        service = ScannerInternalService()
    }
