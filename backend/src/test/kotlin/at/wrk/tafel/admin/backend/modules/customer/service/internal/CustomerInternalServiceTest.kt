...
class CustomerInternalServiceTest {
    ...
    @RelaxedMockK
    private lateinit var customerPdfInternalService: CustomerPdfInternalService
    ...
    fun `generate pdf customer - found`() {
        ...
        every { customerRepository.findByCustomerId(any()) } returns testCustomerEntity
        every { customerPdfInternalService.generateMasterdataPdf(any()) } returns pdfBytes
