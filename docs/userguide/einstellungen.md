...
Über den Download-Button lässt sich pro Mitarbeiter eine DSGVO-Datenauskunft (Art. 15/20) als PDF-Datei herunterladen – Personalnummer, Name und Anlagedatum. Das ist der einzige Auskunftsweg für Mitarbeiter ohne eigenes Benutzerkonto (z. B. reine Fahrer): sie haben kein Konto, über das sie sich selbst anmelden könnten, und die [Benutzer-Detailseite](benutzer.md) mit ihrem eigenen Export-Button existiert nur für Mitarbeiter mit Benutzerkonto.
