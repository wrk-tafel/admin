...
In beiden Fällen gelten dieselben Regeln: Standardmäßig muss das neue Passwort mindestens 8 und maximal 50 Zeichen lang sein, darf den Benutzernamen nicht enthalten, keine Leerzeichen haben und bestimmte Wörter (z. B. "wrk", "tafel", "roteskreuz") nicht enthalten. Die Passwortregeln werden pro Installation konfiguriert und können darüber hinaus z. B. Groß-/Kleinbuchstaben, Ziffern oder Sonderzeichen verlangen; welche Regeln tatsächlich gelten, steht immer auf der Seite selbst unter "Passwortregeln".
