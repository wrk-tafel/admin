...
**Navigation starten** öffnet die Navigation zur jeweiligen Filiale in der Karten-App des Geräts (am Handy die installierte Karten-App, am Computer die Karte im Browser) — und hakt den Stopp im selben Zug ab, damit unterwegs kein zweiter Tipp nötig ist. Angezeigt bleibt dabei derselbe Stopp, denn die Navigation öffnet sich in einem eigenen Fenster.

**Erledigt & weiter** hakt den Stopp ab und blättert gleich zum nächsten — das ist der Knopf, der unterwegs an jedem Stopp gedrückt wird, ganz ohne Karten-App. Beim letzten Stopp der Route heißt er nur **Erledigt**, weil es nichts mehr weiterzublättern gibt. **Rückgängig** macht das Abhaken für den gerade angezeigten Stopp wieder rückgängig; ebenso **Vorheriger**: Wer einen Stopp zu früh abgehakt hat, blättert zurück und der Stopp ist wieder offen. **Nächster** blättert dagegen nur weiter und hakt nichts ab — so kann eine Route auch vorab in Ruhe durchgesehen werden. Neben dem Stopp werden Uhrzeit und Name der Person angezeigt, die ihn abgehakt hat. Der Zähler oben rechts zeigt den Fortschritt ("2 von 7 Stopps erledigt").

**Restliche Route in Karte öffnen** unterhalb der Stopps übergibt gleich mehrere noch offene Stopps als eine Fahrt an die Karten-App; enthalten sind dabei die nächsten zehn Stopps, bei längeren Routen weist ein Hinweis darauf hin, dass die weiteren Stopps einzeln zu navigieren sind.
