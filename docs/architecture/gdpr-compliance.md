...
G3, G9 and G4 are worth doing regardless of what the operator decides. G2, G1, G13 and G7 are done.
Of what remains, most depends on answers that come from outside this repository — which makes
