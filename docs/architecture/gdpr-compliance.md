...
### G23 A household's consent can now be withdrawn, not just granted
...
| 22 | [G23](#g23-a-households-consent-can-now-be-withdrawn-not-just-granted) no path to honour a withdrawn consent | [#3416](https://github.com/wrk-tafel/admin/issues/3416) | done | `DELETE /api/households/{householdId}/consent-withdrawal`, audited under `HouseholdConsentWithdrawal` |
