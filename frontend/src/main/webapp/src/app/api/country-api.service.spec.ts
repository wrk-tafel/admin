...
describe('CountryApiService', () => {
  ...
  it('fetch all countries for admin', () => {
    const mockCountries: CountryAdminData[] = [
      {id: 0, name: 'Österreich', enabled: true},
      {id: 1, name: 'Deutschland', enabled: false}
    ];
  ...
  it('create country', () => {
    const newCountry: CountryCreateData = {name: 'Neuland', enabled: true};
  ...
  it('update country', () => {
    const updatedCountry: CountryAdminData = {id: 0, name: 'Österreich', enabled: false};
