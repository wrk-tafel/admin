...
describe('CustomerDetailComponent', () => {
    ...
    it('initial data loaded and shown correctly', () => {
        ...
        const expectedPaginationData: TafelPaginationData = {count: mockNotesResponse.items.length, currentPage: mockNotesResponse.currentPage, totalCount: mockNotesResponse.totalCount, totalPages: mockNotesResponse.totalPages, pageSize: mockNotesResponse.pageSize};
