...
describe('CustomerSearchComponent', () => {
  ...
  it('loads the first page of customers without being asked to, and stays silent about it', () => {
    ...
    expect(apiService.searchCustomer)
      .toHaveBeenCalledWith(undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined);
  ...
  it('restores query, filters and page from the URL when returning to the screen', () => {
    ...
    expect(apiService.searchCustomer)
      .toHaveBeenCalledWith('Muster', true, undefined, undefined, undefined, undefined, undefined, 2, undefined);
    // A restore must not rewrite the URL that was just used to arrive here.
    expect(router.navigate).not.toHaveBeenCalled();
  });

  it('restores the willBeDeletedSoon filter from the URL when returning to the screen', () => {
    queryParams = {'wird-bald-geloescht': 'true'};
    TestBed.resetTestingModule();
    configureTestBed();
    apiService.searchCustomer.mockReturnValue(of(searchCustomerMockResponse));
    ...
    expect(apiService.searchCustomer)
      .toHaveBeenCalledWith(undefined, undefined, undefined, undefined, undefined, undefined, true, undefined, undefined);
  });
  ...
  describe('the omnibox', () => {
    ...
    it('falls back to the fuzzy search with the digits as text when no exact customer matches', () => {
      ...
      expect(apiService.searchCustomer)
        .toHaveBeenCalledWith('999', undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined);
    ...
    it('runs the fuzzy search directly for a non-numeric query', () => {
      ...
      expect(apiService.searchCustomer)
        .toHaveBeenCalledWith('muster', undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined);
    ...
    it('debounces search-as-you-type and waits for at least two characters', () => {
      ...
      expect(apiService.searchCustomer)
        .toHaveBeenLastCalledWith('mu', undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined);
    });
    ...
    it('lets the explicit search bypass the debounce and the two-character threshold', () => {
      ...
      expect(apiService.searchCustomer)
        .toHaveBeenLastCalledWith('m', undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined);
    });
  ...
  describe('filters', () => {
    ...
    it('toggling a filter chip re-searches without attempting the exact-id jump', () => {
      ...
      expect(apiService.getCustomer).not.toHaveBeenCalled();
      expect(apiService.searchCustomer)
        .toHaveBeenLastCalledWith('42', undefined, true, undefined, undefined, undefined, undefined, undefined, undefined);
    });
    ...
    it('search with postProcessing enabled', () => {
      ...
      expect(apiService.searchCustomer)
        .toHaveBeenLastCalledWith(undefined, true, undefined, undefined, undefined, undefined, undefined, undefined, undefined);
    });
    ...
    it('search with valid enabled', () => {
      ...
      expect(apiService.searchCustomer)
        .toHaveBeenLastCalledWith(undefined, undefined, undefined, true, undefined, undefined, undefined, undefined, undefined);
    });
    ...
    it('search with locked enabled', () => {
      ...
      expect(apiService.searchCustomer)
        .toHaveBeenLastCalledWith(undefined, undefined, undefined, undefined, true, undefined, undefined, undefined, undefined);
    });
    ...
    it('search with missingPrivacyNotice enabled', () => {
      ...
      expect(apiService.searchCustomer)
        .toHaveBeenLastCalledWith(undefined, undefined, undefined, undefined, undefined, true, undefined, undefined, undefined);
    });
    ...
    it('search with willBeDeletedSoon enabled', () => {
      ...
      expect(apiService.searchCustomer)
        .toHaveBeenLastCalledWith(undefined, undefined, undefined, undefined, undefined, undefined, true, undefined, undefined);
    });
  });
