...
describe('CheckinComponent', () => {
    ...
    beforeEach(() => {
        ...
        const globalStateServiceSpy = {
            getCurrentDistribution: vi.fn().mockName("GlobalStateService.getCurrentDistribution").mockReturnValue(new BehaviorSubject<DistributionItem>(defaultDistribution))
        };
    ...
    it('ngOnInit', () => {
        ...
        globalStateService.getCurrentDistribution.mockReturnValue(new BehaviorSubject<DistributionItem>(testDistribution));
